...
<?php foreach($procesoclasificacion as $listarclasificacion){?>
		...
		<form id="form1" name="form1" method="post"
			action="../Control/procesos.php?opc=24">
			<table width="454" border="0">
				...
				<tr>
					<td>Codigo:</td>
					<td><input name="codigoClasificacion" type="text" id="codigoClasificacion"
						readonly="readonly"
						value="<?php echo $listarclasificacion ->codigoClasificacion;?>"
						maxlength="4" placeholder="Codigo" required /></td>
				</tr>
				<tr>
					<td>Nombre:</td>
					<td><input name="nombre" type="text" id="nombre"
						value="<?php echo $listarclasificacion ->nombre;?>"
